...
var llamarSiguientePaso= function(pasoActual){
	...
	$('.arriba').click(function(){		
								...
								$('.swiper-slide').animate({bottom:'-300px',opacity:'0'},(velocidad-100));
								 $('.swiper-slide').html('<p class="paso"><span class="textoPAso">STEP</span> <span class="numeroPaso">' + respuesta.step.step_id+ '</span></p>');
             		$('.swiper-slide').append('<p class="stepAnswer"> Description: ' + respuesta.step.step_description+ ' y mis vecinos son ' + respuesta.step.steps_neighborhood + '</p>');
								$('.swiper-slide').animate({bottom:'300px'},0);
	...
	$('.derecha').click(function(){		
								...
								$('.swiper-slide').animate({left:'-300px',opacity:'0'},(velocidad-100));
								 $('.swiper-slide').html('<p class="paso"><span class="textoPAso">STEP</span> <span class="numeroPaso">' + respuesta.step.step_id+ '</span></p>');
             		$('.swiper-slide').append('<p class="stepAnswer"> Description: ' + respuesta.step.step_description+ ' y mis vecinos son ' + respuesta.step.steps_neighborhood + '</p>');
								crearBotones(2);
	...
	$('.abajo').click(function(){		
								...
								$('.swiper-slide').animate({top:'-300px',opacity:'0'},(velocidad-100));
								 $('.swiper-slide').html('<p class="paso"><span class="textoPAso">STEP</span> <span class="numeroPaso">' + respuesta.step.step_id+ '</span></p>');
             		$('.swiper-slide').append('<p class="stepAnswer"> Description: ' + respuesta.step.step_description+ ' y mis vecinos son ' + respuesta.step.steps_neighborhood + '</p>');
								$('.swiper-slide').animate({top:'300px'},0);
								$('.swiper-slide').animate({top:'0px',opacity:'1'},velocidad);
								crearBotones(2);
						
						});
	$('.izquierda').click(function(){		
						
								$('.swiper-slide').animate({right:'300px',opacity:'0'},(velocidad-100));
								 $('.swiper-slide').html('<p class="paso"><span class="textoPAso">STEP</span> <span class="numeroPaso">' + respuesta.step.step_id+ '</span></p>');
             		$('.swiper-slide').append('<p class="stepAnswer"> Description: ' + respuesta.step.step_description+ ' y mis vecinos son ' + respuesta.step.steps_neighborhood + '</p>');
								$('.swiper-slide').animate({right:'-300px'},0);
								$('.swiper-slide').animate({right:'0px',opacity:'1'},velocidad);
								crearBotones(2);
